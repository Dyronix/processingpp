...
namespace ppp
{
    namespace shader_pool
    {
        ...
        bool initialize()
        {
            ...
            g_ctx.add_shader_program(render::unlit::tags::ui_color::batched(), render::shading_model_type::UNLIT, render::shading_blending_type::UI, render::vertex_type::POSITION_COLOR, render::shaders::unlit::color_vertex_shader_code(), render::shaders::unlit::color_pixel_shader_code());
            g_ctx.add_shader_program(render::unlit::tags::ui_texture::batched(), render::shading_model_type::UNLIT, render::shading_blending_type::UI, render::vertex_type::POSITION_TEXCOORD_COLOR, render::shaders::unlit::texture_vertex_shader_code(), render::shaders::unlit::texture_pixel_shader_code());
            ...
            g_ctx.add_shader_program(render::unlit::tags::ui_color::instanced(), render::shading_model_type::UNLIT, render::shading_blending_type::UI, render::vertex_type::POSITION, render::shaders::unlit::instance_color_vertex_shader_code(), render::shaders::unlit::color_pixel_shader_code());
            g_ctx.add_shader_program(render::unlit::tags::ui_texture::instanced(), render::shading_model_type::UNLIT, render::shading_blending_type::UI, render::vertex_type::POSITION_TEXCOORD, render::shaders::unlit::instance_texture_vertex_shader_code(), render::shaders::unlit::texture_pixel_shader_code());
