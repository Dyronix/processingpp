...
namespace ppp
{
    namespace geometry_pool
    {
        namespace internal
        {
            ...
            {
                static global_hash_map<u64, geometry::geometry, geometry_id_hasher>* s_geometry_map = memory::tagged_placement_new<global_hash_map<u64, geometry::geometry, geometry_id_hasher>>();
