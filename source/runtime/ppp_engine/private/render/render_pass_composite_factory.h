...
namespace ppp
{
    namespace render
    {
        ...
        static std::unique_ptr<composite_pass<T>> create_composite_pass(const string::string_id pass_name, tag<TTag> shader_tag, const string::string_id framebuffer_tag, s32 framebuffer_flags)
        {
        ...
        unlit_composite_pass create_unlit_composite_pass(tag<TTag> shader_tag, const string::string_id framebuffer_tag, s32 framebuffer_flags = framebuffer_flags::COLOR | framebuffer_flags::DEPTH)
        {
        ...
        //-------------------------------------------------------------------------
        template<typename TTag>
        unlit_wireframe_composite_pass create_unlit_wireframe_composite_pass(tag<TTag> shader_tag, const string::string_id framebuffer_tag, s32 framebuffer_flags = framebuffer_flags::COLOR | framebuffer_flags::DEPTH)
        {
        ...
        //-------------------------------------------------------------------------
        template<typename TTag>
        forward_shading_composite_pass create_forward_shading_composite_pass(tag<TTag> shader_tag, const string::string_id framebuffer_tag, s32 framebuffer_flags = framebuffer_flags::COLOR | framebuffer_flags::DEPTH)
        {
        ...
        //-------------------------------------------------------------------------
        template<typename TTag>
        shadow_composite_pass create_shadow_composite_pass(tag<TTag> shader_tag, const string::string_id framebuffer_tag, s32 framebuffer_flags = framebuffer_flags::SAMPLED_DEPTH)
        {
        ...
        //-------------------------------------------------------------------------
        template<typename TTag>
        predepth_composite_pass create_predepth_composite_pass(tag<TTag> shader_tag, const string::string_id framebuffer_tag, s32 framebuffer_flags = framebuffer_flags::COLOR | framebuffer_flags::DEPTH)
        {
