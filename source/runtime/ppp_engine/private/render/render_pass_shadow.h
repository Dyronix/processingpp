...
namespace ppp
{
    namespace render
    {
        ...
        {
        public:
            shadow_pass(const string::string_id shader_tag, const string::string_id framebuffer_tag, s32 framebuffer_flags = framebuffer_flags::SAMPLED_DEPTH, draw_mode draw_mode = draw_mode::AUTO);
