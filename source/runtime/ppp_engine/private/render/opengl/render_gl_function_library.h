    ...
    namespace render
    {
        namespace opengl
        {
            ...
            public:
                ...
                virtual void shader_source(u32 shader, u64 count, const s8** code, const s32* length) = 0;
                ...
                virtual void get_shader_info_log(u32 shader, u64 maxLength, s32* length, s8* infoLog) = 0;
                ...
                virtual void get_program_info_log(u32 shader, u64 maxLength, s32* length, s8* infoLog) = 0;

                // Uniforms               
                virtual s32 get_uniform_location(u32 program, const s8* name) = 0;
            ...
            public:
                ...
                void shader_source(u32 shader, u64 count, const s8** code, const s32* length) override;
                ...
                void get_shader_info_log(u32 shader, u64 maxLength, s32* length, s8* infoLog) override;
                ...
                void get_program_info_log(u32 shader, u64 maxLength, s32* length, s8* infoLog) override;

                // Uniforms               
                s32 get_uniform_location(u32 program, const s8* name) override;
