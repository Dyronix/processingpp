...
namespace ppp
{
    ...
    namespace render
    {
        using batch_draw_strategy = graphics_unique_ptr<ibatch_render_strategy>;
        using inst_draw_strategy = graphics_unique_ptr<iinstance_render_strategy>;
        ...
        public:
            virtual batch_draw_strategy         make_batch_render_strategy() const { return memory::make_unique<default_batch_render_strategy, memory::persistent_graphics_tagged_allocator<default_batch_render_strategy>>(); }
            virtual inst_draw_strategy          make_inst_render_strategy() const { return memory::make_unique<default_instance_render_strategy, memory::persistent_graphics_tagged_allocator<default_instance_render_strategy>>(); }
