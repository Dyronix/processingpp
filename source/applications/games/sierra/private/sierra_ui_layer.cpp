...
namespace ppp
{
    ...
    void sierra_ui_layer::on_enable()
    {
        ...
        create_button("button0", { 400.0f, 200.0f, 0.0f }, { 255, 0, 0, 255 });
        create_button("button1", { 600.0f, 200.0f, 0.0f }, { 0, 255, 0, 255 });
        create_button("button2", { 800.0f, 200.0f, 0.0f }, { 0, 0, 255, 255 });
    }
    ...
    void sierra_ui_layer::create_camera()
    {
        ...
        camera_comp.tag = camera::tags::orthographic();
    ...
    //-------------------------------------------------------------------------
    void sierra_ui_layer::create_button(const char* tag, const glm::vec3& position, const glm::vec4& color)
    {
        ...
        e.set<ecs::render_properties_component>({ true }); // hide to start
        e.set<ecs::shape_component>({
            []() { ppp::rect(150.0f, 150.0f); }   /*.draw_fn */
            });
